...
public class WrapperAPI {
	...
	public void method() {
		...
		// 1. 객체생성구문 통해서 클래스 타입으로 변경
		Integer i1 = new Integer(num1);
		
		// 2. 객체생성하지 않고 곧바로 대입(AutoBoxing)
		Integer i2 = num2; // new Integer(num2);
		
		System.out.println(i1.equals(i2));
		System.out.println(i1.equals(10));
		System.out.println(i1.compareTo(i2)); 	// 두값을 비교해서 기준값이 크면 1, 전달값이 크면 -1, 동일하면 
		
		// 문자열을 Integer 타입으로 변환하고 싶을 때 -> 객체생성을 통해서 가능
