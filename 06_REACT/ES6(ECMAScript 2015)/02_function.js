...
// 함수의 기본 매개변수
function greet(name = "방문자", msg = "졸려") {
...
greet(undefined, "누구십니까");     // 시스템이 정해준 빈 값(개발자가 선언 후 사용하지 않은 값)
...
const add3 = (a, b) => a+b;
// 매개변수가 한개라면 () 도 생략 가능
const print = msg => console.logo(msg);
...
run(() => {
    console.log("run이 실행됨222");
})

run(() => {
    console.log("run이 실행됨333333");
})