...
public class Run {
	...
	/*
	 * 제네릭
	 * 제네릭을 사용하지 않고 Object와 같은 넓은 범위를 수용할 수 있는 필드 변수의 타입을 사용시 -> 형 변환 필요, 런타임 오류
	 * 클래스나 메서드가 사용할 데이터 타입을 컴파일 시점에 지정할 수 있도록 지원하는 문법 -> 매개 타입(객체 생성시 타입을 전달받아 결정)
	 * 
	 * */
...
//		iBox.setValue("value");	매개타입이 Integer 이므로 String 전달 불가
		iBox.setValue(100);
